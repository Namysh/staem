<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
        width="40" height="40" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
        <defs>
            <path id="IconifyId18049881937a09dd319"
        ...
        <g fill="#214B6B">
            <use xlink:href="#IconifyId18049881937a09dd319"></use>
            <use xlink:href="#IconifyId18049881937a09dd319"></use>
        </g>
    </svg>
</template>